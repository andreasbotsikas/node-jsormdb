...
// We could drop all existing entries, but this db is fresh new
// myDB.remove();
...
// Get all data
var result = myDB.find(); // Equivelant to myDB.db.find();
// Display them
...
result = myDB.find({where: query, fields: fields});
